...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "ZOBA", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("zobadb.sqlite")
    ...
    func generateOnBoardingWithImage() -> OnboardingViewController
    {
        ...
        zobaPage.actionButton.tintColor = UIColor.blue
        zobaPage.actionButton.setTitleColor(UIColor(red: 0.0, green: 122.0/255.0, blue: 1.0, alpha: 1.0), for: UIControlState())
    ...
    func setupNormalRootVC(_ animated : Bool) {
        ...
        if animated {
            UIView.transition(with: self.window!, duration: 0.5, options:.transitionCrossDissolve, animations: { () -> Void in
                ...
                let initialViewControlleripad : LoginViewController = mainStoryboardIpad.instantiateViewController(withIdentifier: "mainStoryBoard") as! LoginViewController
