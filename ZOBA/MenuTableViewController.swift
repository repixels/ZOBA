...
class MenuTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        case 6:
            ...
            {
            case 0:
                let firebaseStoryBoard = UIStoryboard.init(name: "Firebase", bundle: nil)
                let firebaseLogin = firebaseStoryBoard.instantiateViewControllerWithIdentifier("firebaseLogin")
                
                self.slideMenuController()?.changeMainViewController(firebaseLogin
                    , close: true)
            default:
                break
            }
