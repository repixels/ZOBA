...
class EditPasswordViewController: UIViewController {
    ...
    @IBAction func isOldPasswordValid(sender: HoshiTextField)
    {
        ...
        {
            showErrorMessage("Enter a valid password", textField: sender)
            
        }
        else
        {
            hideErrorMessage("Current Pasword Valid", textField: sender)
    ...
    @IBAction func isNewPasswordMatch(sender: HoshiTextField)
    {
        ...
        {
            hideErrorMessage("Password Matched", textField: self.currentPassword)
        }
        else
        {
            showErrorMessage("Password Mismatch", textField: self.currentPassword)
